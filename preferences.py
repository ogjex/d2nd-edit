...
def create_default_preferences(file_path):
    default_preferences = {
        ...
        "column_no_mon_den_normal": 63,
        "column_no_mon_den_nightmare": 64,
        "column_no_mon_den_hell": 65,
        "column_no_umon_spawn_normal_min": 66,
        "column_no_umon_spawn_normal_max": 67,
        "column_no_umon_spawn_nightmare_min": 68,
        "column_no_umon_spawn_nightmare_max": 69,
        "column_no_umon_spawn_hell_min": 70,
        "column_no_umon_spawn_hell_max": 71,
